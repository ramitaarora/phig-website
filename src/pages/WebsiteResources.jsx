        ...
        <div>
            ...
            <main className={css`display: flex; flex-wrap: wrap; justify-content: space-evenly;margin:200px`}>
                {websiteResources.map((resource, index) =>
                    <div key={index} className={css`height:233px;width: 493px; margin:10px;margin-bottom:20px;border: 2px solid lightgrey; padding: 40px; border-bottom:2px solid #97C159 `}>
