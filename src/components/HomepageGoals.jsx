...
export default function Goals() {
    return (
        <section id="homepage-goals" className={css`background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.45)), url('./images/homepage/goal-banner.png'); height: 500px; width: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; color: white; display: flex; justify-content: flex-end; align-items: center; @media (max-width: 768px) { height: fit-content; }`}>
            <div className={css`width: 90%; height: 80%; background-color: rgba(255, 255, 255, 0.2); display: flex; padding: 3%; @media (max-width: 800px) { flex-direction: column; margin: 0 auto; width: 100%; height: 100%; }`}>
                <div className={css`width: 35%; display: flex; flex-direction: column; justify-content: space-evenly; padding: 3%; @media (max-width: 800px) { width: 100%; text-align: center; justify-content: center; align-items: center; }`}>
                ...
                <div className={css`display: flex; flex-direction: column; flex-wrap: wrap; width: 30%; padding: 3%; @media (max-width: 800px) { width: 100%; flex-direction: row; }`}>
