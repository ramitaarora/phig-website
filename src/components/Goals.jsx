        ...
        <section id="goals" className={css`background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.45)), url('./phig-website/images/homepage/goal-banner.png'); height: 500px; width: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; color: white; display: flex; justify-content: flex-end; align-items: center;`}>
            <div className={css`width: 90%; height: 80%; background-color: rgba(255, 255, 255, 0.2); display: flex; padding: 3%;`}>
                ...
                <div className={css`display: flex; flex-direction: column; justify-content: space-between; flex-wrap: wrap; width: 60%; padding: 3%;`}>
                    <div>
                        <img src="./phig-website/images/homepage/goal-icon-water.png" alt="water-conservation" className={css`height: 50px;`}/>
                        <p>Demonstrate water conservation</p>
                    </div>
                    <div>
                        <img src="./phig-website/images/homepage/goal-icon-wildlife.png" alt="wildlife" className={css`height: 50px;`}/>
                        <p>Create a wildlife habitat</p>
                    </div>
                    <div>
                        <img src="./phig-website/images/homepage/goal-icon-plant.png" alt="plant" className={css`height: 50px;`}/>
                        <p>Provide a hands-on experience for all ages</p>
                    </div>
                    <div>
                        <img src="./phig-website/images/homepage/goal-icon-community.png" alt="community" className={css`height: 50px;`}/>
                        <p>Create a community area of natural beauty</p>
                    </div>
                    <div>
                        <img src="./phig-website/images/homepage/goal-icon-replace.png" alt="replace" className={css`height: 50px;`}/>
