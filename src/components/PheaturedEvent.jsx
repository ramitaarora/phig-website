    ...
    return (
        <div id="pheatured-event">
            ...
            <div className={css`display: flex; justify-content: space-between; margin: 0 80px;`}>
                <div id="overlay-header" className={css`background-color: rgba(255, 255, 255, 0.95); position: relative; top: -50px; display: flex; justify-content: center; align-items: center; width: 60%; text-align: center; padding: 20px; height: 100px; box-shadow: 2px 2px 2px lightgrey; width: 60%;`}>
                ...
                <div id="event-date" className={css`background-color: white; position: relative; top: -150px; width: 35%; padding: 30px; border: 1px solid lightgrey; border-radius: 10px; box-shadow: 0px 0px 20px grey; display: flex; flex-direction: column; justify-content: space-evenly;`}>
