...
export default function HomepageCards() {
    return (
        <section id="homepage-cards" className={css`margin: 90px auto; width: 80%; display: flex; flex-wrap: wrap; justify-content: space-between;`}>
            <div id="each-homepage-card" className={css`box-shadow: 0px 5px 5px lightgrey; width: 350px; display: flex; flex-direction: column; justify-content: space-between; border-bottom:3px solid #97C159`}>
                ...
                <div className={css`display: flex; padding: 25px; align-items: center;`}>
                    <Link to="/volunteer"><p className={css`margin-right: 5px; color:#97C159;text-decoration: underline;text-decoration-thickness: 0.2em;`}>Learn More</p></Link>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#97C159" class="bi bi-arrow-right" viewBox="0 0 16 16">
            ...
            <div id="each-homepage-card" className={css`box-shadow: 0px 5px 5px lightgrey; width: 350px; display: flex; flex-direction: column; justify-content: space-between;border-bottom:3px solid #97C159`}>
                ...
                <div className={css`display: flex; padding: 25px; align-items: center;`}>
                    <Link to="/approach"><p className={css`margin-right: 5px;  color:#97C159;text-decoration: underline;text-decoration-thickness: 0.2em;`}>Learn More</p></Link>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#97C159" class="bi bi-arrow-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8" />
                    </svg>
                </div>
            ...
            <div id="each-homepage-card" className={css`box-shadow: 0px 5px 5px lightgrey; width: 350px; display: flex; flex-direction: column; justify-content: space-between;border-bottom:3px solid #97C159`}>
                ...
                <div className={css`display: flex; padding: 25px; align-items: center;`}>
                    <Link to="/events"><p className={css`margin-right: 5px;color:#97C159;text-decoration: underline;text-decoration-thickness: 0.2em;`}>Learn More</p></Link>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#97C159" class="bi bi-arrow-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8" />
                    </svg>
                </div>
