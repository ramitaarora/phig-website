        ...
        <section id="pheatured-book" className={css`margin: 90px auto; width: 95%; box-shadow: 5px 5px 5px 5px lightgrey;`}>
            <div className={css`display: flex; justify-content: space-between; align-items: center;`}>
                ...
                <div className={css`width: 60%`}>
                    ...
                    <div className={css`display: flex; justify-content: space-between; align-items: center;`}>
                        <div>
                            <img src="./phig-website/images/homepage/pheatured-book.jpeg" alt="pheatured-book" />
                        </div>
                        <div>
                ...
                <div className={css`width: 40%`}>
                    ...
                    <div className={css`display: flex; justify-content: space-between; align-items: center;`}>
                        <img src="./phig-website/images/homepage/book-1.jpeg" alt="pheatured-book" className={css`height: 150px;`}/>
                        <div>
                    ...
                    <div className={css`display: flex; justify-content: space-between; align-items: center;`}>
                        <img src="./phig-website/images/homepage/book-2.jpeg" alt="pheatured-book" className={css`height: 150px;`}/>
                        <div>
                    ...
                    <div className={css`display: flex; justify-content: space-between; align-items: center;`}>
                        <img src="./phig-website/images/homepage/book-3.jpeg" alt="pheatured-book" className={css`height: 150px;`}/>
                        <div>
