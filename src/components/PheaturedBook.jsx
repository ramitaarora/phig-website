...
export default function PheaturedBook() {
    return (
        ...
        <section id="pheatured-book" className={css`background: radial-gradient(circle, rgba(255, 255, 255, 0.7) 30%, rgba(232, 232, 232, 0.7) 60%), url('./images/homepage/leaf-background.jpeg'); background-position: bottom right; background-repeat: no-repeat; margin: 90px auto; width: 95%; box-shadow: 5px 5px 5px 5px lightgrey; @media (max-width: 1000px) { background-position: top right; }`}>
            <div id='pheatured-book-section' className={css`display: flex; justify-content: space-evenly; align-items: center; @media (max-width: 1000px) { flex-direction: column; padding: 20px; }`}>

                <div className={css`width: 50%; @media (max-width: 1000px) { width: 100%; }`}>
                    <h3 style={{ marginTop: '40px', marginLeft: '40px', marginBottom: '10px' }}>Pheatured Book</h3>
                    <div><hr style={{ width: '50px', height: '5px', backgroundColor: '#97C159', border: 'none', marginTop: '-10px', marginLeft: '40px' }}></hr></div>
                    <div className={css`display: flex; justify-content: space-between; align-items: center; @media (max-width: 550px) { flex-direction: column; }`}>
                        <div className={css`padding: 40px; width: 40%; @media (max-width: 550px) { width: 100%; margin: 0 auto; }`}>
                            <a href="https://www.goodreads.com/book/show/43212849-nature-s-best-hope?ac=1&from_search=true&qid=1MbdBR5Sns&rank=1" target="_blank" rel="noreferrer" >
                                <img id="pheatured-book-image" src="./images/homepage/pheatured-book.jpeg" alt="Nature's Best Hope - Tallamy" title="Nature's Best Hope - Tallamy" loading="lazy" />
                            </a>
                        </div>
                        <div className={css`font-size: medium; margin: 40px; width: 60%; @media (max-width: 550px) { width: 100%; margin: 0 auto; padding: 0 40px; }`}>
                            ...
                            <div className={css`display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;`}>
                                ...
                                <a href="https://www.goodreads.com/book/show/43212849-nature-s-best-hope?ac=1&from_search=true&qid=1MbdBR5Sns&rank=1" target="_blank" rel="noreferrer">
                                    <button id="view-goodreads-button" className={css`border-radius: 10px; cursor: pointer; padding: 5px 10px; border: 6px; font-size: big; background-color: #407D46; color: white;`}>View on Goodreads</button>
                                </a>
                            </div>
                ...
                <div id="similar-titles" className={css`width: 50%; margin-right: 40px; @media (max-width: 1000px) { width: 100%; margin: 0 40px; } @media (max-width: 550px) { padding: 0 40px; }`}>
                    ...
                    <div className={css`@media (max-width: 1000px) { display: flex; align-items: center; justify-content: flex-start; flex-wrap: wrap; } @media (max-width: 450px) { flex-direction: column; }`}>
                        <div className='each-book'>
                            <div className='each-book-image'>
